...
export function EditorData() {
  return (
    <div>
      <h3>
        Try React
        React has been designed from
        the start for gradual adoption, and you can use as little or as much React as you need.
        ...
        Even if you don’t know anything about React yet,
        ...
        check out this overview of React by Tania Rascia.
        It introduces the most important React concepts in a detailed,
        ...
        but it’s harder to learn both React and JavaScript at the same time.

        We recommend going through this JavaScript overview to check your knowledge level.
        It will take you between 30 minutes and an hour
      </h3>
    </div>
  );
}
